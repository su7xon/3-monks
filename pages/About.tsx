    ...
    <div className="pt-20 md:pt-32 pb-10 md:pb-20 bg-white min-h-screen text-gray-900">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <section className="mb-16 md:mb-40">
          ...
          <h1 className="text-3xl md:text-[10rem] font-oswald font-black uppercase tracking-tighter leading-none mb-8 md:mb-20 text-mask">MANIFESTO</h1>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 items-center">
            <div className="aspect-square md:aspect-[3/4] bg-gray-100 overflow-hidden">
              <img src="https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=1920&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-80" alt="About" />
            </div>
            <div className="space-y-4 md:space-y-8">
              ...
              <div className="space-y-4 md:space-y-6 text-sm md:text-lg text-gray-500 font-light leading-relaxed">
                <p>
